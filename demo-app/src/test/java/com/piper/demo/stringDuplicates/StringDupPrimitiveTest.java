 ...
 */
public class StringDupPrimitiveTest 
    extends TestCase
{
    /**
     ...
     */
    public StringDupPrimitiveTest( String testName )
    {
        super( testName );
    }
    ...
    {
        return new TestSuite( StringDupPrimitiveTest.class );
    }
...
//                System.out.println("Testing objects");
                for (int x = 0; x < iterations; x++) {
                        ...
                        StringDupPrimitive stringDupObject = new StringDupPrimitive( "asdad");
...
//              assertTrue( false );
 ...
 //               System.out.println("Testing objects");
                for (int x = 0; x < iterations; x++) {
                        long start_time_ob = System.nanoTime();
                        StringDupPrimitive stringDupObject = new StringDupPrimitive( "a");
                        String dupedString = stringDupObject.getDuplicateCounts();
 //                       System.out.println("The original string is: " + stringDupObject.getValue());
 //                       System.out.println("The duped string is: " + dupedString);
...
//              assertTrue( false );
  ...
  //              System.out.println("Testing objects");
                for (int x = 0; x < iterations; x++) {
                        long start_time_ob = System.nanoTime();
                        StringDupPrimitive stringDupObject = new StringDupPrimitive( "");
                        String dupedString = stringDupObject.getDuplicateCounts();
  //                      System.out.println("The original string is: " + stringDupObject.getValue());
  //                      System.out.println("The duped string is: " + dupedString);
